...
<html lang="en">
    ...
    <body>
        <div class="container">
            <h1>LogIn Meme Portal</h1>
            <hr>
            
            <form>
                <div class="form-group">
                    <label for="exampleInputUsername">Username</label>
                    <input type="text" class="form-control" id="exampleInputUsername" aria-describedby="textHelp" placeholder="Username">
                </div>
                <div class="form-group">
